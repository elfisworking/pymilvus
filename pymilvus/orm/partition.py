...
class Partition:
    ...
    def search(self, data, anns_field, param, limit, round_decimal=-1, expr=None, output_fields=None, timeout=None,
               **kwargs):
        """
        ...
        """
        conn = self._get_connection()
        res = conn.search_with_expression(self._collection.name, data, anns_field, param, limit, round_decimal,
